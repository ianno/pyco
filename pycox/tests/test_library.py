...
def minimal_library(library, library_component, false_component, next_component, future_component):
    ...
    mapping = RefinementPortMapping(next_component.contract, future_component.contract)
    ...
    mapping_1 = RefinementPortMapping(false_component, library_component)
    ...
    mapping_2 = RefinementPortMapping(next_component, library_component)
    ...
    mapping_3 = RefinementPortMapping(future_component, library_component)
    ...
    mapping_4 = RefinementPortMapping(false_component, next_component)
    ...
    mapping_5 = RefinementPortMapping(false_component, future_component)
